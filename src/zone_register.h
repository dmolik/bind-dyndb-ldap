...
isc_result_t
zr_del_zone(zone_register_t *zr, const dns_name_t *origin) ATTR_NONNULLS ATTR_CHECKRESULT;
...
isc_result_t
zr_get_zone_dn(zone_register_t *zr, const dns_name_t *name, const char **dn) ATTR_NONNULLS ATTR_CHECKRESULT;
